            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$user->email}}</td>
                        <td>
                           <a href="/employee/{{$user->id}}/edit" class="btn btn-outline-primary btn-sm"> <i class="fas fa-user-edit"></i></a>
                           ...
                           <form id="delete-user-{{$user->id}}" action="/employee/{{$user->id}}" method="post" style="display: none;">
                             @csrf
                             @method("DELETE")
                           </form>
                        </td>
